...
if(isset($_GET['id'])){
  $id=$_GET['id'];
  $delete=mysqli_query($con, "DELETE FROM chits WHERE chit_id=$id ");
...
<body>
  ...
  <main id="main" class="main">
    ...
    <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active">View Chits</li>
        </ol>
      </nav>
    </div>
    <!-- End Page Title -->
   ...
   <tbody>
      <?php
$sql=mysqli_query($con,"select * from chits order by chit_id ");
...
{ ?>
     ...
     <tr>
       ...
       <td><?php echo $result['months']; ?></td>
        ...
        <td> <a href="viewchits.php? id=<?php echo $result['chit_id'];?>"> Delete </a></td>
