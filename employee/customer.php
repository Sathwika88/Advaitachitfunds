...
if(isset($_POST['submit']))
{
  ...
  $sql=mysqli_query($con, "insert into customer(full_name, phone_number, email, address, remarks, password) values ('$_POST[name]', '$_POST[mobile]', '$_POST[email]', '$_POST[address]', '$_POST[remark]', '$_POST[password]')") or die(mysqli_error($con));
...
<!-- End Sidebar-->
  ...
  <div class="form-group">
    ...
    <input type="number" name="mobile" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Enter phone  number">
  ...
  <div class="form-group">
    ...
    <input type="text" name="remark" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Enter remarks">
